...
<body>
  <div id="eliminarUser.php">
    <div class="modal fade" id="deleteModal">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          <!-- cabecera del modal -->
          <div class="modal-header" style="background-color: #dc2430;">
            <h4 class="modal-title mdi mdi-account-remove text-white">Eliminar alumno</h4>
          ...
          <div class="modal-footer">
            ...
            <button type="" class="btn btn-success" style="background-color: #dc2430;border-color:#000000;" name="delete">Eliminar</button>
          </div>
          </form>
        </div>
      </div>
  ...
  <div class="card text-center m-5" style="border-color:#dc2430;">
    <div class="card-header mdi mdi-table-row-remove text-white" style="background-color: #dc2430;border-color:#fe8c00;">
      Listado de alumnos
    </div>
    <div class="card-body">
      <h5 class="card-title ">Los siguientes son los datos guardados hasta el momento y en la cual puedes elimar el registro del alumno:</h5>
    </div>
    <div class="card text-center m-5">
      <div class="card-header" style="background-color:#dc2430">
        <div class="container">
              ...
              <tbody bgcolor="#ffffff">
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-primary deleteBtn mdi mdi-account-remove" style="background-color: #dc2430;border-color:#dc2430;" data-toggle="modal" data-id="codigo" data-target="viewModal">Eliminar</button>
                      </td>
                    </tr>
                <?php
                  }
